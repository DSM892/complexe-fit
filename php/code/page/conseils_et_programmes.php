        ...
        <div>
            <ul>
                <a href="https://conseilsport.decathlon.fr/la-methode-pilates-pourquoi-est-elle-efficace"><li>
                    ...
                    <h2>La méthode Pilates : pourquoi est elle efficace ?</h2>
                    <p>Développer le corps de façon harmonieuse, rectifier les mauvaises postures, renforcer la sangle abdominale...</p>
                </li></a>
                ...
                <a href="https://conseilsport.decathlon.fr/cest-quoi-lendurance-fondamentale"><li>
                    ...
                    <p>Et si pour progresser en course à pied, le secret était de courir lentement ? On vous explique tout sur l’endurance fondamentale.</p>
                </li></a>
                ...
                <a href="https://conseilsport.decathlon.fr/sport-et-ecologie-des-initiatives-pour-notre-climat"><li>
                    ...
                    <h2>Comment entretenir son sac ?</h2>
                ...
                <a href="https://conseilsport.decathlon.fr/8-exercices-avec-des-halteres-ma-routine-fitness"><li>
                    ...
                    <h2>Sport et écologie : des initiatives pour limiter son impact</h2>
                ...
                <a href="https://conseilsport.decathlon.fr/entretenir-et-laver-ses-chaussures-de-running"><li>
                    ...
                    <p>Pour garantir une meilleure durée de vie à vos chaussures de course à pied, mais aussi pour des raisons d'hygiène et d'odeur.</p>
                </li></a>
                ...
                <a href="https://conseilsport.decathlon.fr/faire-du-sport-avec-son-chien-quelles-precautions-prendre"><li>
                    ...
                    <p>Les effets du sport sur le cerveau, vous avez deja entendu parler ? Vous ne vous en souvenez plus ? Cet article pourrait bien vous aider a vous en rappeler.</p>
                </li></a>
                ...
                <a href="https://conseilsport.decathlon.fr/les-bienfaits-du-sport-sur-le-cerveau"><li>
                    ...
                    <p>Quand on a la chance d’être l’heureux·se compagnon·ne d’un·e chien·ne, l’idee de faire du sport ensemble est allechante pour tout le monde</p>
                </li></a>
            </ul>
        </div>
    </main>
