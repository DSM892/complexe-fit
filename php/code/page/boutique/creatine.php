...
<body>
    ...
    <main id="produit_main">
        <div class="slider" id="boutique_slider">
            ...
            <div class="slides">
                <div class="slide first"><img src="../../../images/creatine/1.jpg" alt="Image creatine 1"></div>
                <div class="slide"><img src="../../../images/creatine/2.jpg" alt="Image creatine 2"></div>
                <div class="slide"><img src="../../../images/creatine/3.jpg" alt="Image creatine 3"></div>
            </div>
        ...
        <div id="produit_description">
            ...
            <a href="https://www.decathlon.fr/p/creatine-monohydrate-labellisee-creapure-neutre-300g/_/R-p-327680?mc=8601333&fl=Neutre">En savoir plus</a>
        </div>
    </main>
