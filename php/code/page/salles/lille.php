...
<head>
    ...
    <title>Complexe-Fit Lille</title>
...
<body>
    ...
    <main id="salles_specifique_main">
        <h1>Complexe-Fit Lille</h1>
        <h2>158 Rue Barthélemy Delespaul, 59000 Lille</h2>
        <p>
            Bienvenue au Complexe-Fit Lille ! Notre salle de sport située au cœur 
            de la métropole lilloise vous offre un espace moderne et équipé pour tous vos 
        ...
        <div id="details_salles_specifique1">
            <img src="../../../images/salles/lille.jpg" alt="Complexe-Fit Lille">
