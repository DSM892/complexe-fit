...
<head>
    ...
    <title>Complexe-Fit Paris</title>
...
<body>
    ...
    <main id="salles_specifique_main">
        <h1>Complexe-Fit Paris</h1>
        <h2>87 Rue du Temple, 75003 Paris</h2>
        <p>
            Bienvenue au Complexe-Fit Paris ! Notre salle de sport située au cœur 
        ...
        <div id="details_salles_specifique1">
            <img src="../../../images/salles/paris.jpg" alt="Complexe-Fit Paris">
