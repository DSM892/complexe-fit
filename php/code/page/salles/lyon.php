...
<body>
    ...
    <main id="salles_specifique_main">
        <h1>Complexe-Fit Lyon</h1>
        <h2>42 Rue de la République, 69002 Lyon</h2>
        <p>
            Bienvenue au Complexe-Fit Lyon ! Notre salle de sport située au cœur 
            de la métropole lyonnaise vous offre un espace moderne et équipé pour tous vos 
        ...
        <div id="details_salles_specifique1">
            <img src="../../../images/salles/lyon.jpg" alt="Complexe-Fit Lyon">
