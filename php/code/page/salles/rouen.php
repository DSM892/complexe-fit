...
<head>
    ...
    <title>Complexe-Fit Rouen</title>
...
<body>
    ...
    <main id="salles_specifique_main">
        <h1>Complexe-Fit Rouen</h1>
        <h2>17 rue de la Seille, 76000 Rouen</h2>
        <p>
            Bienvenue au Complexe-Fit Rouen ! Notre salle de sport située au cœur 
            de la capitale vous offre un espace moderne et équipé pour tous vos 
        ...
        <div id="details_salles_specifique1">
            <img src="../../../images/salles/rouen.jpg" alt="Complexe-Fit Rouen">
